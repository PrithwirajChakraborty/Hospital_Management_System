	...
	<div class='sidebar'>
		<div class='sidebar-area'> 
			...
			<ul class='sidebar-menu'>
				...
				<li><a href='covid.php'><img class='sidebar-menu-icon' src='images/ic_error_outline_white_24dp.png'  /> Covid</a></li>
				<li><a href='reports.php'><img class='sidebar-menu-icon' src='images/ic_receipt_white_24dp.png'  /> Covid Reports</a></li>
			</ul> 
		</div> 
	</div>
	<?php 
